...
function Effects() {let history = useHistory();
  ...
  <div>
    ...
    <div style={{padding:"10px", width:"100%"}}><iframe width="300" height="315" src="https://www.youtube-nocookie.com/embed/4rzii77SPT8?controls=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
...
function Stages() {let history = useHistory();
  ...
  <div>
    ...
    <div style={{padding: "10px", width: "100%"}}><iframe width="300" height="315" src="https://www.youtube-nocookie.com/embed/oJ9mhS7aQUA?controls=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
